...
public abstract class CompositeShape extends Shape {
     ...
     * @throws ShapeDoesNotSupportChildren if this shape is not a composite
     */
    ...
    public List<Shape> getShapesByType(ShapeType circle) {
        List<Shape> typeList = new ArrayList<Shape>();
    ...
    public List<Shape> getLeafShapes() {
        // TODO: Implement
        List<Shape> leaflist = new ArrayList<Shape>();
        for (Shape shape :
                shapes)
            if (LeafShape.class.equals(shape.getClass()))
                leaflist.add(shape);
