...
public class BookStoreFacadeTest extends AbstractClientTest {
    ...
    protected BookstoreFacade createFacade() {
        ...
        BookstoreFacade implementation = new DefaultBookstoreFacade();
        implementation.setNotificationService(customerNotificationService);
        implementation.setBookService(bookService);
        implementation.setCustomerService(customerService);
        implementation.setWarehouseService(warehouseService);
        implementation.setOrderingService(orderingService);
